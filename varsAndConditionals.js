/*
    ...
    and loops to play out a fight between obiwann vs anakin skywalker
*/ 
let obiwanAttack = 25
let anakinAttack = 35
...
for(let i = 0; i < 5;i++){
    obiwanHealth -= (anakinAttack - obiwanDefense)
     if(obiwanHealth <= 0){
     console.log("Obiwans was slain")
} else{
    console.log( 'Obiwans heal is now at ' + obiwanHealth)
...
console.log('obiwans health is now at ' + obiwanHealth)
if(obiwanHealth <= 0){
    console.log('Obiwan lost the high ground')
  }
}
